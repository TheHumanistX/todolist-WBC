...
const TaskDetails = ({ onEdit, onDelete, onConfirm }) => {
    ...
    useEffect(() => {
        ...
        setDueDateV(selectedTask ? format(new Date(selectedTask.dueDate), 'MM/dd/yyyy') : null);
        console.log('dueDateV: ', dueDateV)
        console.log('selectedTask.dueDate: ', selectedTask.dueDate ? selectedTask.dueDate : null)
    }, [selectedTask]);
    console.log('dueDateV: ', dueDateV)
