...
const HeaderBar = ({ taskList }) => {
    ...
    return (
        ...
        <Box display="flex" justifyContent="space-between" alignItems="center" p={2} width='100%' height='50px' padding="0px 30px" borderRadius='25px'  bgcolor='cardBackgroundColor.main' >
            ...
            <Typography variant="h6">{`List: ${ selectedTaskList ? listName : null}`}</Typography>
            <Typography variant="h6">{`Tasks Completed: ${selectedTaskList ? tasksCompleted : null} of ${selectedTaskList ? totalTasks : null}`}</Typography>
