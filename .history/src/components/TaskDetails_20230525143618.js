...
const TaskDetails = ({ onEdit, onDelete, onConfirm }) => {
    ...
    const [taskName, setTaskName] = useState(selectedTask ? selectedTask.taskName : "");
    const [dueDateV, setDueDateV] = useState(selectedTask ? new Date(selectedTask.dueDate) : null);
    ...
    useEffect(() => {
        ...
        setDueDateV(selectedTask ? new Date(selectedTask.dueDate) : null);
    }, [selectedTask]);
    console.log('dueDateV: ', dueDateV)
    useEffect(() => {
        if (dueDateV) {
            setDueDate(format(dueDateV, 'MM/dd/yyyy'));
        } else {
            setDueDate("");
        }
    }, [dueDateV]);
    ...
    const createdDate = selectedTask.createdDate ? format(new Date(selectedTask.createdDate), 'MM/dd/yyyy') : "";
    const dueDate = selectedTask.dueDate ? format(new Date(selectedTask.dueDate), 'MM/dd/yyyy') : "";
    console.log('dueDate: ', dueDate)   
    const currentDate = selectedTask ? format(new Date(), 'MM/dd/yyyy') : "";
