...
const TaskList = ({ taskList }) => {
    const { selectedTaskList, setSelectedTaskList, handleTaskListClick, setCurrentListTitle } = useContext(TodoContext);
    ...
    return (
        <div>
            ...
            <SmallMenu anchorEl={anchorEl} handleClose={handleClose} setCurrentListTitle={setCurrentListTitle} listName={listName} />/>
            <ListEdit />
        </div>
