...
const TaskList = ({ taskList }) => {
    const { selectedTaskList, setSelectedTaskList, handleTaskListClick, setCurrentListTitle, handleEditTaskList } = useContext(TodoContext);
    ...
    return (
        <div>
            ...
            <SmallMenu anchorEl={anchorEl} handleClose={handleClose} handleEdit={handleEditTaskList.bind(null, listId)} handleDelete={handleListDelete.bind(null, listId)} />
            <ListEdit />
        </div>
