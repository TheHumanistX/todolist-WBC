...
const TaskList = ({ taskList }) => {
    ...
    return (
        <div>
            ...
            <SmallMenu menuAnchorElement ={menuAnchorElement } handleClose={handleClose} handleEdit={handleEditTaskList.bind(null, listId)} handleDelete={handleListDelete.bind(null, listId)} />
            <ListEdit />
        </div>
