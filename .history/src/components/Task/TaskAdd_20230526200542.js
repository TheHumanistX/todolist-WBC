...
const TaskAdd = () => {
  ...
  const handleConfirm = () => {
    ...
    handleTaskAdd(selectedTaskList.listId, { newTaskId, taskName, createdDate, dueDate: formattedDueDate, completed: false, description });
    setTaskName('');
    setDueDate(null);
    setDescription('');
  };
  ...
  return (
    <>
      ...
      <Box display="flex" justifyContent="space-between" mt={2}>
        ...
        <IconButton onClick={() => handleTaskAdd(null)} size="small">
          <CloseOutlined
            sx={{ color: 'buttonColor.main' }}
            fontSize="large"
          />
