...
const Task = ({ task }) => {
    ...
    const { selectedTask, setSelectedTask, setTaskDelete, selectedTaskList, handleTaskDelete } = useContext(TodoContext);
    ...
    return (
        <div style={{width: '100%', display: 'flex', justifyContent: 'center'}}>
            ...
            >
                ...
                <RemoveCircleOutline onClick={handleDeleteTask} id={taskId} sx={{ color: iconColor(), width: 35, height: 35 }} />
