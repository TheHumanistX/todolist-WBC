    ...
    return (
        <>
            <Typography variant="h6" mb={1}>
                Created: {format(utcToZonedTime(selectedTask.createdDate, 'UTC'), 'MM/dd/yyyy')}
            </Typography>
            ...
            {console.log('TaskEdit dueDate right before the line: ', selectedTask.dueDate)}
            <LocalizationProvider dateAdapter={AdapterDateFns}>
                    <DatePicker
                        label="Due Date"
                        value={format(utcToZonedTime(new Date(dueDate), 'UTC'), 'MM/dd/yyyy')}
