  ...
  return (
    <LinearProgress
      ...
      sx={{
        ...
        borderColor: 'cardBackgroundColor.alternate', // Set the color of the border.
        bgcolor: 'cardBackgroundColor.main', // Set the background color of the progress bar.
        // Target the filled portion of the progress bar (with class '.MuiLinearProgress-bar') to apply specific styles.
        '& .MuiLinearProgress-bar': {
          bgcolor: 'backgroundColor.default', // Set the filled bar color.
        },
      }}
    />
  );
