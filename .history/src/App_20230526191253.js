...
//   console.log('selectedTaskList in APP.js:  ', selectedTaskList)
//   // const [selectedTask, setSelectedTask] = useState(null);

//   const handleTaskListClick = (taskList) => {
//     console.log('handleTaskListClick entered')
...
//     console.log('handleTaskUpdate selectedTaskList: ', selectedTaskList)
            ...
            <Grid container gap='3vw' justifyContent='center' style={{ height: "100%" }}>
              ...
              <Grid item container xs={8}>
                <Stack width='100%' spacing={2}>
                  ...
                  <Box display='flex' gap='3vw' height='100%'>
                    <Tasks />
                    {/* Pass the appropriate functions as props to TaskDetails */}
                    <TaskDetails
                      onConfirm={() => {}}
                      onTaskAdd={(listId, newTask) => handleTaskAdd(listId, newTask)}
                    />
                  </Box>
                </Stack>
              </Grid>
