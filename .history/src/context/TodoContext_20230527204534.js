...
export const TodoProvider = ({ children }) => {
    ...
    const handleListTitleUpdate = (listId, newTitle) => {
        ...
        if (!taskListToUpdate) {
            console.error("Task list not found for the given list Id");
            return;
        }
    
        // Create a new taskList object with the updated title
        const updatedTaskList = {
            ...taskListToUpdate,
            listName: newTitle,
        };
   
        // Update the taskLists array with the updated taskList
