...
export const TodoProvider = ({ children }) => {
    ...
    const handleTaskToggleCompleted = (listId, taskId) => {
        ...
        let updatedUncompletedTasks;
        let updatedCompletedTasks;
    
        // If the task is now completed, move it to the end of the uncompleted tasks
        if (updatedTask.completed) {
            updatedUncompletedTasks = uncompletedTasks;
        updatedCompletedTasks = [...completedTasks, updatedTask];

    } else {
        // If the task is now uncompleted, move it before the completed tasks
        updatedUncompletedTasks = [...uncompletedTasks, updatedTask];
