...
function App() {
  ...
  return (
    <TodoProvider>
      <ThirdwebProvider theme={theme(mode)}>
        <ThemeProvider theme={theme}>
          <Box bgcolor={theme(mode).palette.background.default} style={{ padding: "23px 34px", height: "100vh", boxSizing: 'border-box'}}>
            <Grid container gap='3vw' justifyContent='center' style={{ height: "100%", maxHeight: "100%" }}>
              <Grid item container xs={3}>
                <Lists toggleColorMode={toggleColorMode} theme={theme(mode)} />
              </Grid>
